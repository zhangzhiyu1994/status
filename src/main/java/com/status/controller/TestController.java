...
import com.status.config.WXConfig;
import com.status.task.AsyncTask;
...
//        asyncTask.task3();
        ...
        return JsonData.successData( end - begin);
...
//        return JsonData.buildSuccess(map);
        ...
        return JsonData.successData(map);
